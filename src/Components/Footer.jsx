...
import i1 from "../assets/Icon Container (7).png"
import i2 from "../assets/Icon Container (8).png"
import i3 from "../assets/Icon Container (9).png"
import i4 from "../assets/Icon Container (10).png"
  ...
  return (
    <footer className="bg-[#0F0F0F] pt-20 pb-10 px-4 md:px-6">
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        <div className="bg-[#1A1A1A] border border-[#262626] rounded-[32px] p-10 md:p-16">
